...
if DATASET == 'Potsdam':
	...
	#('composite', BASE_FOLDER + 'composite/', 'composite_mosaic_09cm_area{}.tif')
    ]
...
data_lmdbs = [(DATASET_DIR + 'composite_train/', DATASET_DIR + 'composite_train_lmdb')]

test_lmdbs = [(DATASET_DIR + 'composite_test/', DATASET_DIR + 'composite_test_lmdb')]
...
MODEL_FOLDER = '../models/'
INIT_MODEL = '../models/vgg16fc.caffemodel'
CAFFE_MODE = 'gpu'
CAFFE_DEVICE = 0
IGNORE_LABEL = 5
TRAIN_DATA_SOURCE = DATASET_DIR + 'composite_train_lmdb'
TRAIN_LABEL_SOURCE = DATASET_DIR + 'labels_train_lmdb'
TEST_DATA_SOURCE = DATASET_DIR + 'composite_test_lmdb'
